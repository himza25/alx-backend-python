...
async def wait_n(n: int, max_delay: int) -> List[float]:
    """
    Execute wait_random() n times with specified max_delay, returning durations once completed.
    ...
    Returns:
    List[float]: Durations of each call, returned in the order of their completion.
    """
